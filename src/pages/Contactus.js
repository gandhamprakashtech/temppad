  ...
  return (
    <div className="gradient-background">
      <div className="container">
        <header className="d-flex justify-content-center py-3">
          <ul className="nav nav-pills">
            ...
            <li className="nav-item">
              <Link to="/cont" className="nav-link active">
                Contact us
              </Link>
            </li>
            <li className="nav-item">
      ...
      <div className="container px-4 py-5" id="contact">
        <h2 className="pb-2 border-bottom">Reach out to us on social media:</h2>
          ...
          <div className="feature col">
            <a href="mailto:gandhamprakashtech@gmail.com">
              <button
                ...
                onclick="window.location.href = 'mailto:gandhamprakashtech@gmail.com';"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
